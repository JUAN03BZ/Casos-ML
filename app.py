...
,
...

        {
            ...
            "problema": "Alta inversión en producciones propias sin certeza de éxito: Antes de invertir cientos de millones de dólares en una serie o película original, Netflix debía responder:"

"¿Habrá suficiente audiencia interesada?"

"¿En qué países funcionará mejor?"

"¿Qué actores, directores y géneros garantizan más éxito?"

"Tradicionalmente, los estudios usaban intuición de ejecutivos o análisis de tendencias generales, pero Netflix quiso algo más científico y escalable. ",

            "algoritmo": "A finales de los años 2000, cuando Netflix ya contaba con grandes volúmenes de datos de usuarios, comenzó a implementar Machine Learning supervisado para predecir la demanda de contenido. El sistema utilizaba como entradas variables como género, duración, elenco, director, país, año y el desempeño de títulos similares, y como salida métricas de éxito como horas vistas, porcentaje de finalización y nuevos suscriptores. Para ello aplicó distintos algoritmos: regresión supervisada para estimar audiencias, (árboles de decisión y Random Forest) para clasificar la probabilidad de éxito por segmentos, y más adelante (redes neuronales profundas) para detectar patrones complejos en los datos.",
